...
from src.services.translation_api import translate as api_translate
...
class Dota2TranslationSystem:
    ...
    def _load_vocabulary(self):
        """加载词汇表"""
        try:
            from .词汇表_new import ZH_TO_EN, EN_TO_ZH, PHRASE_TEMPLATES_ZH_TO_EN, PHRASE_TEMPLATES_EN_TO_ZH
    ...
    # ==================== 第5步: 智能路由 ====================
    def _smart_route(self, text: str, email: str = None) -> str:
        """
        ...
        # 优先级3：API翻译
        api_result = self._call_api(text, email=email)
    ...
    # ==================== 第6步: 多引擎翻译 ====================
    def _call_api(self, text: str, email: str = None) -> str:
        ...
        result, engine = api_translate(text, source, target, email=email)
        return result
    ...
    # ==================== 主翻译流程 ====================
    def translate(self, text: str, email: str = None) -> Tuple[str, Dict[str, Any]]:
        """
        完整翻译流程
        返回: (翻译结果, 质量评估)
        """
        ...
        translated = self._smart_route(text, email=email)

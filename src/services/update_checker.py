    ...
    def do_check():
        ...
        for source_type, source_info in sources:
            try:
                ...
                if result['error'] is None or (result['has_update'] and not result['error']):
                    if callback:
                        callback(result)
                    return result
...
if __name__ == "__main__":
    ...
    parser.add_argument('--owner', default='your-owner', help='Gitee用户名')
    parser.add_argument('--repo', default='your-repo', help='Gitee仓库名')
